...
const flowStages = [
  // ETAPA 1 (0.0s - 1.0s): Core envia parâmetros para as 3 fontes
  ...
  // ETAPA 2 (1.0s - 2.0s): Bases seguem para validação humana
  { stage: 1, from: 'node-corporate-db', to: 'node-hitl-research' },
  { stage: 1, from: 'node-external-ms',  to: 'node-hitl-research' },
  { stage: 1, from: 'node-clinics',      to: 'node-hitl-research' },

  // ETAPA 3 (2.0s - 3.0s): Validação humana libera o contexto
  { stage: 2, from: 'node-hitl-research', to: 'node-context-engine' },

  // ETAPA 4 (3.0s - 4.0s): Motor de Contexto aciona o Gerador de Mensagens
  { stage: 3, from: 'node-context-engine', to: 'node-msg-gen' },

  // ETAPA 5 (4.0s - 5.0s): Mensagens aguardam aprovação humana
  { stage: 4, from: 'node-msg-gen', to: 'node-hitl-message' },

  // ETAPA 6 (5.0s - 6.0s): Mensagens aprovadas seguem para execução
  { stage: 5, from: 'node-hitl-message', to: 'node-compliance' },
  { stage: 5, from: 'node-hitl-message', to: 'node-dispatch' }
];

const TOTAL_CYCLE_DURATION = 6; // Ciclo contínuo total
const STAGE_DURATION = 1;       // 1s por estágio
